...
export function PrimaryButton({
  ...
  const isPressed = activeState === 'Press/Clicked';
  ...
  return (
    <button
      ...
      onMouseDown={() => setInteractionState('Press/Clicked')}
      ...
      style={{
        ...
        whiteSpace: 'nowrap',
        overflow: 'hidden',
        // Base layer: default gradient always present
        background: 'linear-gradient(to bottom, #004EBF 0%, #000EBF 100%)',
    ...
    >
      {/* Hover/press overlay fades in on top of the base gradient */}
      <span
        aria-hidden="true"
        style={{
          position: 'absolute',
